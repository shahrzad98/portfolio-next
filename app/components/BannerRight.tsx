  ...
  return (
    <>
      <div className="flex flex-col sm:flex-row sm:text-[60px] text-[40px]  text-white mt-20 ">
        ...
        <div
          className="ml-6 inline relative after:content-['']  after:absolute after:top-16 after:left-0 after:bg-[url('/assets/curve.png')]
      ...
      <div className="mt-20 sm:w-2/3 text-lightGrey text-lg">
